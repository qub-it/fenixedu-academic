...
public class AnyCurricularCourseExecutor extends CurricularRuleExecutor {
    ...
    protected RuleResult executeEnrolmentVerificationWithRules(final ICurricularRule curricularRule,
        ...
        result &= matchesLegacyDegreeAndDegreeType(rule, degree);
        result &= matchesLegacyDepartment(rule, degree, curricularCourseToEnrol, executionInterval);
    ...
    //To Remove
    @Deprecated
    private boolean matchesLegacyDegreeAndDegreeType(final AnyCurricularCourse rule, final Degree degree) {
        return rule.getDegree() != null ? rule.getDegree() == degree : rule
                .hasBolonhaDegreeType() ? degree.getDegreeType() == rule.getBolonhaDegreeType() : true;
    }

    //To Remove
    @Deprecated
    private boolean matchesLegacyDepartment(AnyCurricularCourse rule, Degree degree, CurricularCourse curricularCourseToEnrol,
            ExecutionInterval executionInterval) {
        ...
        return departmentUnit != null && departmentUnit.equals(rule.getDepartmentUnit());
    }
