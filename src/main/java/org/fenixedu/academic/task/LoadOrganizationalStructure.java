...
public class LoadOrganizationalStructure extends CustomTask {
    ...
    public void runTask() throws Exception {
        ...
        final UniversityUnit universityUnit = createUniversityUnit(countryUnit, "Starfleet Univeristy", "SU");
        final SchoolUnit institutionUnit = createSchoolUnit(universityUnit, "Starflet Academy", "SA");
    ...
    private UniversityUnit createUniversityUnit(final CountryUnit countryUnit, final String universityName,
        ...
        return UniversityUnit.createNewUniversityUnit(new MultiLanguageString(Locale.getDefault(), universityName), null, null,
    ...
    private AggregateUnit createAggregateUnit(final Unit parentUnit, final String unitName) {
        return AggregateUnit.createNewAggregateUnit(new MultiLanguageString(Locale.getDefault(), unitName), null, null, null,
                ...
                AccountabilityType.readByType(AccountabilityTypeEnum.ORGANIZATIONAL_STRUCTURE), null, null, Boolean.FALSE, null);
    }
}
