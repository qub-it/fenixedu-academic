...
public class ShowStudentPortalDA extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        if (student != null) {
            for (Registration registration : student.getActiveRegistrationsIn(executionSemester)) {

                final StudentCurricularPlan scp = registration.getStudentCurricularPlan(executionSemester);
                if (scp != null) {

                    final DegreeCurricularPlan degreeCurricularPlan = scp.getDegreeCurricularPlan();
