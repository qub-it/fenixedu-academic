...
public class ProgramConclusionConfigTest {
    ...
    @Test
    public void testProgramConclusionConfig_setNullDegreeCurricularPlanThrowsDomainException() {
        config = create(CONCLUSION_TITLE, degreeCurricularPlan, programConclusion);
        assertThrows(DomainException.class, () -> config.setDegreeCurricularPlan(null));
    }

    @Test
    public void testProgramConclusionConfig_setNullProgramConclusionThrowsDomainException() {
        config = create(CONCLUSION_TITLE, degreeCurricularPlan, programConclusion);
        assertThrows(DomainException.class, () -> config.setProgramConclusion(null));
    }
