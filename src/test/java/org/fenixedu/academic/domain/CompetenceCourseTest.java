...
public class CompetenceCourseTest {
    ...
    public void testCompetenceCourse_findByUnit() {
        ...
        // Test findByUnit for newly created competenceCourseGroupUnit
        ...
        // Test findByUnit for persisted coursesUnit
        competenceCourses =
                CompetenceCourse.findByUnit(coursesUnit, true).collect(Collectors.toSet());

        assertEquals(2, competenceCourses.size());
        assertTrue(competenceCourses.contains(competenceCourseA));
        assertTrue(competenceCourses.contains(competenceCourseB));
    }
}
