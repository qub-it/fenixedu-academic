...
public class CurriculumModuleTest {
    ...
    public void testCurriculumModule_ComparatorByNameAndId() {
        ...
        // sorted by group name: A < B < C
        assertEquals(groupA, modules.get(0));
        assertEquals(groupB, modules.get(1));
        assertEquals(groupC, modules.get(2));

        assertEquals(0, CurriculumModule.COMPARATOR_BY_NAME_AND_ID.compare(groupA, groupA));
    }
    ...
    public void testCurriculumModule_ComparatorByFullPathNameAndId() {
        ...
        // shared path prefix, ordered by the appended name segment: A < B < C
        assertEquals(groupA, modules.get(0));
        assertEquals(groupB, modules.get(1));
        assertEquals(groupC, modules.get(2));

        assertTrue(groupA.getFullPath().contains(" > A"));
        assertEquals(0, CurriculumModule.COMPARATOR_BY_FULL_PATH_NAME_AND_ID.compare(groupA, groupA));
    }
    ...
    public void testCurriculumModule_ComparatorByCreationDate() {
        ...
        assertEquals(0, CurriculumModule.COMPARATOR_BY_CREATION_DATE.compare(groupA, groupA));
    }
    ...
    public void testCurriculumModule_GetFullPath() {
        ...
        // the root has no ancestors, hence no separator
