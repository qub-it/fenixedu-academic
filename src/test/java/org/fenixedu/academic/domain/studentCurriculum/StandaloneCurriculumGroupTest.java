...
public class StandaloneCurriculumGroupTest {
    ...
    private static final String DCP_NAME = "Standalone DCP";
    private static final String STUDENT_USERNAME = "standalone.group.test.student";
    private static final String EMPTY_GROUP_USERNAME = "standalone.group.empty.student";
    ...
    public static void init() {
        FenixFramework.getTransactionManager().withTransaction(() -> {
            ...
            final DegreeCurricularPlan dcp = new DegreeCurricularPlan(degree, DCP_NAME, AcademicPeriod.THREE_YEAR, firstSemester);
            ...
            final StudentCurricularPlan emptyScp = createRegistration(dcp, EMPTY_GROUP_USERNAME, executionYear);
