...
public class NoCourseGroupCurriculumGroupTest {
    ...
    public static void init() {
        ...
        FenixFramework.getTransactionManager().withTransaction(() -> {
            ...
            // A child CurriculumGroup under the group, so its order can be looked up
    ...
    public void testNoCourseGroupCurriculumGroup_searchChildOrderForChild() {
        ...
        // A real child group is found in the ordered list -> non-negative position
